...
object ChannelCatalog {
    val channels: List<Channel> = listOf(
        ...
        Channel(
            ...
            category = ChannelCategory.SPORTS,
            streamUrl = "https://sabcpluscdn.sportscastafrica.com/sca/smil:sca.stream.smil/master.m3u8",
            streamType = StreamType.HLS,
            officialSourceUrl = "https://sabc-plus.com/sport",
        ...
        Channel(
            ...
            name = "BRICS Africa",
            category = ChannelCategory.NEWS,
            streamUrl = "https://sabcbrtanw.cdn.mangomolo.com/br/smil:br.stream.smil/master.m3u8",
            streamType = StreamType.HLS,
        ...
        Channel(
            ...
            streamType = StreamType.HLS,
            officialSourceUrl = "https://capetowntv.org",
            logoUrl = "https://raw.githubusercontent.com/iptv-org/logos/master/capetowntv.png",
            fallbackText = "Cape Town TV",
            description = "South Africa's vibrant community television station broadcasting local news, culture, documentaries, and arts.",
            slogan = "Free to Air, Free to Share",
            broadcastLanguage = "English, Afrikaans, isiXhosa",
            quality = "HD 720p",
            isActive = true,
            isGeoRestricted = false
        ),
        Channel(
            ...
            streamType = StreamType.HLS,
            officialSourceUrl = "https://tshwanetv.org.za",
            logoUrl = "https://raw.githubusercontent.com/iptv-org/logos/master/tshwanetv.png",
            fallbackText = "Tshwane TV",
            description = "Pretoria and Gauteng community television with grassroots news, local music, youth shows, and talk series.",
            slogan = "Voice of the Capital",
            broadcastLanguage = "Sepedi, Setswana, English",
            quality = "HD 720p",
            isActive = true,
            isGeoRestricted = false
        ),
        Channel(
            ...
            streamType = StreamType.HLS,
            officialSourceUrl = "https://1kzntv.co.za",
            logoUrl = "https://raw.githubusercontent.com/iptv-org/logos/master/1kzntv.png",
            fallbackText = "1KZN TV",
            description = "KwaZulu-Natal's regional community broadcaster covering local heritage, traditional music, and regional events.",
            slogan = "Sikubeka Esithombeni",
            broadcastLanguage = "isiZulu, English",
            quality = "HD 720p",
            isActive = true,
            isGeoRestricted = false
        ),
